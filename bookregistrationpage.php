...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <h1 class="masthead-heading text-uppercase mb-0">Book Registration Page</h1>
                <!-- Masthead Subheading-->
    ...
    <div class="container">
            ...
            <div class="mb-3">
                ...
                <input type="text" placeholder="Book name.." class="form-control" name="Book" id="Book" aria-describedby="Book">
            </div>
            <div class="mb-3">
                <label for="Author" class="form-label">Author Name</label>
                <input type="text" placeholder="Author Name..." class="form-control" name="Author" id="Author">
            </div>
            <div class="mb-3">
                <label for="Publisher" class="form-label">Publisher Name</label>
                <input type="text" placeholder="Publisher Name..." class="form-control" name="Publisher" id="Publisher">
            </div>
